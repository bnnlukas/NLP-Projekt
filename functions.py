...
PlacementTeam = return_answer('Which Team became the 1st place in 2006?', 'PlacementTeam')
TeamPlacement = return_answer('Which place did Argentina become in 1986?', 'TeamPlacement')
